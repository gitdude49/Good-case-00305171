...
//************************************ GDFileReader ****************************
      ...
      cordovaRef.exec(
          ...
          function(r) {
              ...
              if (file.type.indexOf('image/') > -1) {
                me.result = 'data:' + file.type + ';base64,' + Base64.decode(r);
              } else {
  ...
  GDFileTransfer.prototype.upload = function (filePath, server, successCallback, errorCallback, options, trustAllHosts) {
      ...
      cordovaRef.exec(win, errorCallback, 'GDFileTransfer', 'upload', [filePath, server, fileKey, fileName, mimeType, params, trustAllHosts, chunkedMode, headers]);
  };
...
;(function() {
  ...
  */
  ...
  GDXMLHttpRequest.prototype.send = function (optData) {
    ...
    cordovaRef.exec(successCallback, null, "GDXMLHttpRequest", "send", parms);
  };
