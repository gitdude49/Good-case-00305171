 ...
 * Call this \ss_function to execute a Good Dynamics name service lookup. The
 ...
 * Call this \ss_function to execute a Good Dynamics name service lookup and
 * supply extended data to the results callback. This \ss_function does the same
 * lookup as the \ref GD_nslookup() \ss_function, see above.
 *
